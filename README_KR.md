...
[English](README_EN.md) | [한국어](README_KR.md)
  ...
  - <b>다양한 장르와 템포의 음악을 제공하여 사용자의 다양한 음악 취향과 운동 유형에 맞게 제공 할 예정입니다.

  - 사용자가 운동중 원하는 노래를 틀기위해 손을 사용해야만 하는 경우가 있는데 이를 해결하기 위해 제작하였습니다.
...
<br>
<br>
  - 음악 감상을 할 수 있는 창을 제공합니다.(관리자만 사용 가능합니다.) <br>
...
1-2. V1버전에서의 직접 로그인 및 가입 기능 구현
   ...
   - 다양한 보안 및 인증 기술을 직접 탐구함으로써, 다양한 기술에 대한 이해를 넓히고, 기술 스택에 대해 발전하고 싶기 때문입니다..
