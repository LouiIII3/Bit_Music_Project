...
class ExerciseRoutineContainer: Identifiable { // 운동 루틴이 저장되는 곳
    ...
    var exerciseDefaultModel: [ExerciseDefaultModel]? // 여러개의 루틴을 저장할 수 있다
...
struct ExerciseData {
    ...
    static let sholderpress = ExerciseDefaultModel(exerciseName: "숄더프레스", part: [.shoulders], tool: .dumbbell)
    static let armcurl = ExerciseDefaultModel(exerciseName: "이두컬", part: [.biceps], tool: .dumbbell)
